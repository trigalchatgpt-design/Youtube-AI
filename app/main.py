...
app = FastAPI(title="YouTube AI Studio", version="0.7.0")
...
@app.get("/health")
def health():
    return {"ok": True, "service": "youtube-ai-studio", "version": "0.7.0"}
